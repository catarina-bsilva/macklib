...
const Colors = () => {
  ...
  return (
    <div className="container100 bg-colorLight">
      ...
      <div style={{display: 'none'}} >
        <p className="padding-2 textAlign-center text-color1 fontSize-md fontWeight-lg"> text-color1 <CopyableText /></p>
        <p className="padding-2 textAlign-center text-color2 fontSize-md fontWeight-lg"> text-color2 <CopyableText /></p>
        <p className="padding-2 textAlign-center text-color3 fontSize-md fontWeight-lg"> text-color3 <CopyableText /></p>
        <p className="padding-2 textAlign-center text-color4 fontSize-md fontWeight-lg"> text-color4 <CopyableText /></p>
        <p className="padding-2 textAlign-center text-colorLight bg-colorDark width-2 m-a fontSize-md fontWeight-lg"> text-colorLight <CopyableText /></p>
        <p className="padding-2 textAlign-center text-colorDark fontSize-md fontWeight-lg"> text-colorDark <CopyableText /></p>
        <p className="padding-2 textAlign-center text-colorGrey fontSize-md fontWeight-lg"> text-colorGrey <CopyableText /></p>
        <p className="padding-2 textAlign-center text-colorRed fontSize-md fontWeight-lg"> text-colorRed <CopyableText /></p>
        <p className="padding-2 textAlign-center text-colorBlue fontSize-md fontWeight-lg"> text-colorBlue <CopyableText /></p>
        <p className="padding-2 textAlign-center text-colorYellow fontSize-md fontWeight-lg bg-colorDark width-2 m-a"> text-colorYellow <CopyableText /></p>
        <p className="padding-2 textAlign-center text-colorGreen fontSize-md fontWeight-lg"> text-colorGreen <CopyableText /></p>
        <p className="padding-2 textAlign-center text-hover-color1 fontSize-md fontWeight-lg"> text-hover-color1 <CopyableText /></p>
        <p className="padding-2 textAlign-center text-hover-color2 fontSize-md fontWeight-lg"> text-hover-color2 <CopyableText /></p>
        <p className="padding-2 textAlign-center text-hover-color3 fontSize-md fontWeight-lg"> text-hover-color3 <CopyableText /></p>
        <p className="padding-2 textAlign-center text-hover-color4 fontSize-md fontWeight-lg"> text-hover-color4 <CopyableText /></p>
        <p className="padding-2 textAlign-center text-hover-colorLight fontSize-md fontWeight-lg"> text-hover-colorLight <CopyableText /></p>
        <p className="padding-2 textAlign-center text-hover-colorDark fontSize-md fontWeight-lg"> text-hover-colorDark <CopyableText /></p>
        <p className="padding-2 textAlign-center text-hover-colorGrey fontSize-md fontWeight-lg"> text-hover-colorGrey <CopyableText /></p>
        <p className="padding-2 textAlign-center text-hover-colorRed fontSize-md fontWeight-lg"> text-hover-colorRed <CopyableText /></p>
        <p className="padding-2 textAlign-center text-hover-colorBlue fontSize-md fontWeight-lg"> text-hover-colorBlue <CopyableText /></p>
        <p className="padding-2 textAlign-center text-hover-colorYellow fontSize-md fontWeight-lg "> text-hover-colorYellow <CopyableText /></p>
        <p className="padding-2 textAlign-center text-hover-colorGreen fontSize-md fontWeight-lg"> text-hover-colorGreen <CopyableText /></p>
      </div>
      ...
      <div style={{display: 'none'}} >
        <div className="container">
          <p className="padding-2 textAlign-center text-colorDark bg-color1 fontSize-sm fontWeight-lg width-2 m-a"> bg-color1 <CopyableText /></p>
          <p className="padding-2 textAlign-center text-colorDark bg-color2 fontSize-sm fontWeight-lg width-2 m-a"> bg-color2 <CopyableText /></p>
          <p className="padding-2 textAlign-center text-colorDark bg-color3 fontSize-sm fontWeight-lg width-2 m-a"> bg-color3 <CopyableText /></p>
          <p className="padding-2 textAlign-center text-colorDark bg-color4 fontSize-sm fontWeight-lg width-2 m-a"> bg-color4 <CopyableText /></p>
          <p className="padding-2 textAlign-center text-colorDark bg-colorLight fontSize-sm fontWeight-lg width-2 m-a"> bg-colorLight <CopyableText /></p>
          <p className="padding-2 textAlign-center text-colorLight bg-colorDark fontSize-sm fontWeight-lg width-2 m-a"> bg-colorDark <CopyableText /></p>
          <p className="padding-2 textAlign-center text-colorDark bg-colorGrey fontSize-sm fontWeight-lg width-2 m-a"> bg-colorGrey <CopyableText /></p>
          <p className="padding-2 textAlign-center text-colorDark bg-colorRed fontSize-sm fontWeight-lg width-2 m-a"> bg-colorRed <CopyableText /></p>
